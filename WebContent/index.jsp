...
<%@page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%@include file="/templates/inc/header.jsp" %>    
    ...
    <div id="content" class="snap-content">        
	  ...
	  %>
		<h3 style="margin-left: 70px;">Bài đăng mới nhất</h3>
        ...
        <div class="content">
			...
			<%
				...
				String urlSEOFirst = request.getContextPath()+"/trang-chu?page=1";
				String urlSEOLast = request.getContextPath()+"/trang-chu?page="+sumPage;
				String urlSEOPre = request.getContextPath()+"/trang-chu?page="+pre;
				String urlSEONext = request.getContextPath()+"/trang-chu?page="+next;
				%>
				<% if (pre <=0) {%>
				...
				if (sumPage <4) {
					for (int i=1; i<=sumPage;i++){
						...
						String urlSEO = request.getContextPath()+"/trang-chu?page="+i;
						if (i==1){
							%>	
				...
				for (int i=current_page; i<=current_page+3;i++){
					...
					String urlSEO = request.getContextPath()+"/trang-chu?page="+i;if (i==1){
						%>	
						<a <%=active %> style=" text-align: center;" href="<%=urlSEO%>"><%=i %></a>
						<%} else {%>
						<a <%=active %> style=" text-align: center;" href="<%=urlSEO%>">|<%=i %></a>
